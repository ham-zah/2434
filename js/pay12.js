...
/* PAY */
    ...
    payQRIS = PB1+'payqris'+PB2+imgQRIS+PB3+'<img src="https://nama.business/img/0/qris_crop1.jpg"/><p class="text-center"><a href="https://nama.business/img/0/qris_full1.jpg" download="qris_nama.business" rel="nofollow noopener" target="_blank">View atau Download QR</a></p><p>* Pembayaran melalui QRIS memerlukan proses validasi 1-3 hari. Apabila tidak ingin menunggu proses validasi silakan gunakan metode pembayaran lainnya.</p>'+PB4;

rwID.innerHTML = '<div class="taptopay">'+payTAP+payJAGO+payBCAD+payDANA+payVA+payQRIS+'</div>';
