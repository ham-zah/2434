...
/* PAY */
    ...
    payDANAMON = PB1+'paydanamon'+PB2+imgDANAMON+PB3+'<p>Nama Bank : Bank Danamon</p><p>Nomor Rekening : <span>003646168439</span></p><p>Kode Bank : <span>011</span></p><p>Untuk transfer dari bank lain yang berbeda, pilihlah menu transfer antar bank/transfer ke bank lain, pilih nama bank, lalu masukan kode bank + nomor rekening bank, lanjutkan transaksi sampai selesai.</p>'+PB4,
    ...
    payQRIS = PB1+'payqris'+PB2+imgQRIS+PB3+'<img src="https://nama.business/img/0/qris_crop1.jpg"/><p class="text-center"><a href="https://nama.business/img/0/qris_full1.jpg" download="qris_namabusiness" oncontextmenu="return false" rel="nofollow noopener" target="_blank">Download QRIS</a></p><p>* Pembayaran melalui QRIS memerlukan proses validasi 1-3 hari. Apabila tidak ingin menunggu proses validasi silakan gunakan metode pembayaran lainnya.</p>'+PB4;

rwID.innerHTML = '<div class="taptopay">'+payTAP+payVA+payJAGO+payBCAD+payDANAMON+payDANA+payQRIS+'</div>';
...
doc.querySelector("#tapdanamon").addEventListener("click",function(){
doc.querySelector("#paydanamon").style.display="block"});
